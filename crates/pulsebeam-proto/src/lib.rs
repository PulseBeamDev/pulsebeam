...
// Generated by prost-build into OUT_DIR. Doc text is copied verbatim from the
// `.proto`, so its formatting is not ours to fix here.
#[allow(clippy::doc_lazy_continuation)]
pub mod reliable {
    include!(concat!(env!("OUT_DIR"), "/reliable.rs"));
}
